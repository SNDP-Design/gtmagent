        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
            ...
            <div className="rounded-2xl bg-card border border-border/60 p-7">
              ...
              <Link href="/sign-up-login" className="block w-full py-3 text-center rounded-lg border border-border text-[13px] font-semibold text-foreground hover:bg-secondary transition-colors">
                Get started free
              </Link>
            </div>
            ...
            <div className="rounded-2xl bg-card border border-primary/40 p-7 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Link href="/sign-up-login" className="btn-primary block w-full py-3 text-center text-[13px] shadow-btn-primary">
      ...
      <footer className="py-8 px-6 border-t border-border/40">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/sign-up-login" className="text-[12px] text-primary font-semibold hover:underline">Sign in</Link>
          </div>
        </div>
      </footer>
    </div>
