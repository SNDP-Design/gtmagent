...
import { Sparkles, Target, FlaskConical, Mail, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 bg-background">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-foreground">Welcome to GTM Fox</h2>
            <p className="text-[13px] text-muted-foreground mt-1.5">Sign in to access your GTM workspace</p>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-xl border border-border bg-card hover:bg-muted text-[14px] font-semibold text-foreground transition-all duration-150 hover:border-primary/40 hover:shadow-card disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isLoading ? (
          ...
          <p className="text-center text-[12px] text-muted-foreground mt-6">
            New to GTM Fox?{' '}
            <span className="text-primary font-semibold">Your account is created automatically on first sign-in.</span>
          </p>
        </div>
      </div>
    </div>
